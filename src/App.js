...
function App() {
  ...
  return (
    <div
      className="overflow-hidden relative App"
      onMouseMove={({ clientX: x, clientY: y }) => set({ xy: calc(x, y) })}
    >
      <Navbar />
      <Navdots springParams={props.xy}></Navdots>
      <Fullpage>
        <Slide id="1" color="bg-red-200">
        ...
        <Slide active id="2" color="bg-blue-300">
          <div className="relative flex">
            <Overlay lines>
              <div className="z-10 container flex px-10">
                ...
                >
                  ...
                  <p className="text-white text-center sm:text-left bounceIn animated">
                    ...
                    Amet facere, fugiat unde harum velit rerum commodi odit
                    neque repellat alias nostrum recusandae laboriosam officiis,
                    deleniti obcaecati vitae a doloribus quis.
                  </p>
                  <br />
                  <a
                    href="#"
